...
if __name__ == '__main__':
    ...
    parser.add_argument('--prepared-train-labels', type=str, required=False,
                        default='scripts/prepared_train_annotation.pkl',
                        help='path to the file with prepared annotations')
    parser.add_argument('--train-images-folder', type=str, required=False, default='/home/kls/data/coco/train2017/',
    ...
    parser.add_argument('--checkpoint-path', type=str, required=False,
                        default='weights/mobilenet_sgd_68.848.pth.tar',
                        help='path to the checkpoint to continue training from')
    # parser.add_argument('--checkpoint-path', type=str, required=False,
    #                     default='output/default_checkpoints/checkpoint_iter_190.pth',
    #                     help='path to the checkpoint to continue training from')
    ...
    parser.add_argument('--experiment-name', type=str, default='output/default',
    ...
    parser.add_argument('--val-labels', type=str, required=False,
                        default='scripts/val_subset.json',
                        help='path to json with keypoints val labels')
    parser.add_argument('--val-images-folder', type=str, required=False, default='/home/kls/data/coco/val2017/',
                        help='path to COCO val images folder')
    parser.add_argument('--val-output-name', type=str,
                        default='output/detections.json',
                        help='name of output json file with detected keypoints')
    parser.add_argument('--checkpoint-after', type=int, default=100,
