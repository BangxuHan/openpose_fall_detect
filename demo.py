...
def infer_fast(net, img, net_input_height_size, stride, upsample_ratio, cpu, pad_value=(0, 0, 0),
...
def detect_main(video_source='', image_source='', video_name=''):
    ...
    parser.add_argument('--checkpoint-path', type=str, default='openpose.jit', help='path to the checkpoint')
    parser.add_argument('--height-size', type=int, default=256, help='network input layer height size')
    parser.add_argument('--video', type=str, default='', help='path to video file or camera id')
    parser.add_argument('--images', nargs='+', default='', help='path to input image(s)')
    parser.add_argument('--cpu', default='False', action='store_true', help='run network inference on cpu')
...
if __name__ == '__main__':
    detect_main(video_source=r'test1.avi', video_name='video1')
