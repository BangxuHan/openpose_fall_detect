...
if __name__ == '__main__':
    ...
    parser.add_argument('--labels', type=str, required=False,
                        default='/home/kls/data/coco/annotations/person_keypoints_val2017.json',
    ...
    parser.add_argument('--images-folder', type=str, required=False, default='/home/kls/data/coco/val2017',
