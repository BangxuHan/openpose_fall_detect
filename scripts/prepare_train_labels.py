...
if __name__ == '__main__':
    ...
    parser.add_argument('--labels', type=str, required=False,
                        default='/home/kls/data/coco/annotations/person_keypoints_train2017.json',
                        help='path to json with keypoints train labels')
    parser.add_argument('--output-name', type=str,
                        default='/home/kls/PycharmProjects/openpose_fall_detect/scripts/prepared_train_annotation.pkl',
    ...
    print("prepare train labels successful!\nsaved = 'scripts/prepared_train_annotation.pkl'")
