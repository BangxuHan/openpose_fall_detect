...
def run_demo(net, action_net, image_provider, height_size, cpu, track, smooth):
    ...
    with open("/home/kls/PycharmProjects/openpose_fall_detect/performance_evaluation/action_result.txt", "a") as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint-path', type=str,
                        default='/home/kls/PycharmProjects/openpose_fall_detect/weights/checkpoint_iter_370000.pth',
                        help='path to the checkpoint')
    parser.add_argument('--height-size', type=int, default=256, help='network input layer height size')
    parser.add_argument('--video', type=str, default='', help='path to video file or camera id')
    parser.add_argument('--images', nargs='+', default=r'/home/kls/data',
                        help='path to input image(s)')
    # C:\Users\lieweiai\Desktop\val_openpose\fall
    ...
    action_net.load_state_dict(
        torch.load("/home/kls/PycharmProjects/openpose_fall_detect/action_detect/checkpoint/action.jit"))
